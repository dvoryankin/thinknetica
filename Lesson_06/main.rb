  ...
  def  attach_carriage
    if @trains.size > 0
      ...
      if choice <= @trains.size
        @trains[choice-1].add_carriage(PassengerCarriage.new(producer)) if @trains[choice-1].type == "passenger"
        @trains[choice-1].add_carriage(CargoCarriage.new(producer)) if @trains[choice-1].type == "cargo"
