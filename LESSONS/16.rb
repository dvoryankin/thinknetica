ActiveRecord Callbacks: http://rusrails.ru/active-record-callbacks
Кастомные валидации: http://rusrails.ru/active-record-validations#vypolnenie-sobstvennyh-validatsiy
ActiveRecord Query Interface: http://rusrails.ru/active-record-query-interface
Single Table Inheritance: http://api.rubyonrails.org/classes/ActiveRecord/Inheritance.html
Еще об STI: http://eewang.github.io/blog/2013/03/12/how-and-when-to-use-single-table-inheritance-in-rails/
