...
train1 = Train.new '555-555', 'sapsan', 'passenger'
train2 = Train.new '555-555', 'sapsan', 'passenger'
train3 = Train.new '555-555', 'sapsan', 'passenger'
train4 = Train.new '555-555', 'sapsan', 'passenger'
ptrain = PassengerTrain.new('555555', 'passenger')
ctrain = CargoTrain.new('11111','cargo')
train = Train.new('11111','passenger')
